...
Cards = YAML.load_file('data/events.yml')
Squib::Deck.new(cards: Cards.size, layout: 'layout/events.yml') do
  set_background
...
Squib::Deck.new(cards: Personas.size, layout: 'layout/personas.yml') do
  ...
  png file: Personas.map {|i| "faces/#{i['icon'].downcase}" }, layout: 'photo'
